...
DEFAULT_REFLECTOR_MAX_TOKENS = 16_384
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--budget", type=int, default=4_000)
...
def main() -> None:
    ...
    import gepa
    from utils import ExactBoxedMathAdapter, assert_local_vllm_is_running
    ...
    if args.budget < len(train) + len(validation):
        raise ValueError("--budget must be at least the total dataset size")
